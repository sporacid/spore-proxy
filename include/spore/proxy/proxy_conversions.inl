...
namespace spore
{
    ...
    {
        struct proxy_semantics_conversion_copy_and_move
        {
            static constexpr bool can_copy = true;
            static constexpr bool can_move = true;
        };

        struct proxy_semantics_conversion_copy_only
        {
            static constexpr bool can_copy = true;
            static constexpr bool can_move = false;
        };

        struct proxy_semantics_conversion_disabled
        {
        ...
        struct proxy_semantics_conversion : proxy_semantics_conversion_disabled {};

        template <any_proxy_facade facade_t>
        struct proxy_semantics_conversion<
            proxy_value_semantics<facade_t>, proxy_value_semantics<facade_t>> : proxy_semantics_conversion_copy_and_move {};

        template <any_proxy_facade facade_t>
        struct proxy_semantics_conversion<
            proxy_pointer_semantics<facade_t>, proxy_pointer_semantics<facade_t>> : proxy_semantics_conversion_copy_only {};

        template <any_proxy_facade facade_t>
        struct proxy_semantics_conversion<
            proxy_pointer_semantics<facade_t>, proxy_pointer_semantics<const facade_t>> : proxy_semantics_conversion_copy_only {};

        template <any_proxy_facade facade_t>
        struct proxy_semantics_conversion<
            proxy_pointer_semantics<const facade_t>, proxy_pointer_semantics<const facade_t>> : proxy_semantics_conversion_copy_only {};
...
#if 0
        template <any_proxy_semantics semantics_t, any_proxy_facade other_facade_t>
        struct proxy_semantics_conversion<
            semantics_t, proxy_value_semantics<other_facade_t>> : proxy_semantics_conversion_copy_and_move {};
        ...
        template <any_proxy_facade facade_t, any_proxy_semantics other_semantics_t>
        struct proxy_semantics_conversion<
            proxy_forward_semantics<facade_t&>, other_semantics_t> : proxy_semantics_conversion_copy_only {};
        ...
        //        template <any_proxy_facade facade_t, any_proxy_semantics other_semantics_t>
        //        struct proxy_semantics_conversion<
        //            proxy_value_semantics<facade_t>, other_semantics_t> : proxy_semantics_conversion_copy_and_move {};
        //
        //        template <any_proxy_facade facade_t>
        //        struct proxy_semantics_conversion<
        //            proxy_pointer_semantics<facade_t>, proxy_pointer_semantics<facade_t>> : proxy_semantics_conversion_copy_only {};
        ...
        //     proxy_value_semantics<other_facade_t>>
        //     : proxy_semantics_conversion_copyable
        //{
        // };
    }
