...
namespace spore
{
    ...
    namespace proxies
    {
        namespace detail
        {
            ...
            void* get_func_ptr(const dispatch_mapping<func_t, self_t, return_t(args_t...)>) noexcept
            {
